...
oshrun -display-map -np 192 -npernode 12 ./PR -u 29 -k 64 -n 1 &> $HOME/Dist_Mem_GAPBS/results/pr/test_8.txt
...
oshrun -display-map -np 64 -npernode 4 ./PR -u 30 -k 64 -n 1 &> $HOME/Dist_Mem_GAPBS/results/pr/test_12.txt

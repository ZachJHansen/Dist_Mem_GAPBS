...
oshrun -display-map -np 64 -npernode 4 ./TC -u 29 -k 64 -n 1 &> $HOME/Dist_Mem_GAPBS/results/tc/test_10.txt
...
#oshrun -display-map -np 64 -npernode 4 ./TC -u 30 -k 64 -n 1 &> $HOME/Dist_Mem_GAPBS/results/tc/test_12.txt

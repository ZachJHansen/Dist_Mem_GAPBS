...
#oshrun -display-map -np 256 -npernode 16 ./BC -u 28 -k 64 -n 8 &> $HOME/Dist_Mem_GAPBS/results/bc/test_2.txt
...
#oshrun -display-map -np 192 -npernode 12 ./BC -u 28 -k 64 -n 8 &> $HOME/Dist_Mem_GAPBS/results/bc/test_4.txt
...
#oshrun -display-map -np 64 -npernode 4 ./BC -u 28 -k 64 -n 8 &> $HOME/Dist_Mem_GAPBS/results/bc/test_6.txt
#echo '===============Test 6 Complete!==============='

export SHMEM_SYMMETRIC_HEAP_SIZE=18G
#oshrun -display-map -np 192 -npernode 12 ./BC -g 29 -k 64 -n 8 &> $HOME/Dist_Mem_GAPBS/results/bc/test_7.txt
#echo '===============Test 7 Complete!==============='
oshrun -display-map -np 192 -npernode 12 ./BC -u 29 -k 64 -n 1 &> $HOME/Dist_Mem_GAPBS/results/bc/test_8.txt
...
oshrun -display-map -np 64 -npernode 4 ./BC -u 29 -k 64 -n 1 &> $HOME/Dist_Mem_GAPBS/results/bc/test_10.txt
...
oshrun -display-map -np 64 -npernode 4 ./BC -u 30 -k 64 -n 1 &> $HOME/Dist_Mem_GAPBS/results/bc/test_12.txt

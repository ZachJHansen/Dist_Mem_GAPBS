...
oshrun -display-map -np 192 -npernode 12 ./TC -u 28 -k 64 -n 1 &> $HOME/Dist_Mem_GAPBS/results/tc/test_4.txt
...
oshrun -display-map -np 64 -npernode 4 ./TC -u 28 -k 64 -n 1 &> $HOME/Dist_Mem_GAPBS/results/tc/test_6.txt

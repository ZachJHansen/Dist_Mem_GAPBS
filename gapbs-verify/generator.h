...
class Generator {
 ...
 public:
  ...
  static void InsertWeights(pvector<WEdge> &el) {
    ...
    orig_out.open("/home/zach/projects/Dist_Mem_GAPBS/gapbs/gapbs/src/weights_output.txt", std::ios::app);
    for(WEdge wait : el)
